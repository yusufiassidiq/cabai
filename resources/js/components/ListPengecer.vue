              ...
              <ul class="pagination">
                <li>
                  <button
                    ...
                    v-on:click="fetchPaginatePengecer(pagination.prev_page_url)"
                ...
                <li>
                  <button
                    class="btn btn-default"
                    v-on:click="fetchPaginatePengecer(pagination.next_page_url)"
...
export default {
  data() {
    return {
      ...
      // pagination
      pagination: [],
      url_getMitra: "/kemitraan/pengecer/list"
    };
  },
  methods: {
    // prev & next paggination
    fetchPaginatePengecer(url) {
      ...
      swal
        ...
        .then(result => {
          if (result.value) {
            this.$Progress.start();
            axios
              .post("/kemitraan/request/" + id_pengecer)
              .then(() => {
