              ...
              <ul class="pagination">
                <li>
                  <button
                    ...
                    v-on:click="fetchPaginateKonsumen(pagination.prev_page_url)"
                ...
                <li>
                  <button
                    class="btn btn-default"
                    v-on:click="fetchPaginateKonsumen(pagination.next_page_url)"
...
export default {
  data() {
    return {
      ...
      // pagination
      pagination: [],
      url_getMitra: "/kemitraan/konsumen/list"
    };
  },
  methods: {
    // prev & next paggination
    fetchPaginateKonsumen(url) {
