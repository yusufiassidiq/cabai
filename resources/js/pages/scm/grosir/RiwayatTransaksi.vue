            ...
            <div class="card card-primary card-outline card-outline-tabs">
              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  ...
                  <riwTransaksi></riwTransaksi>
                  <!-- riwayat transaksi pemasok -->
                  <riwTransaksiPemasok></riwTransaksiPemasok>
                </div>
              </div>
            </div>
          </div>
...
<script>
import RiwayatTransaksiPelanggan from "../../../components/RiwTransaksiDgnPelanggan"
import RiwayatTransaksiPemasok from './../../../components/RiwTransaksiDgnPemasok'
export default {
  components: {
    riwTransaksi: RiwayatTransaksiPelanggan,
