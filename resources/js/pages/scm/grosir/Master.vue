      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          >
            ...
            <li class="nav-item">
              <router-link to="/grosir/transaksipemasok" class="nav-link">
                <i class="fas fa-file-invoice nav-icon"></i>
                <p>Pemasok</p>
              </router-link>
            </li>
            <li class="nav-item">
              <router-link to="/grosir/transaksipelanggan" class="nav-link">
            ...
            <li class="nav-item">
              <router-link to="/grosir/analitik" class="nav-link">
